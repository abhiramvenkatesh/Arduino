This project is based on concepts of IOT. In this project we control the movement of the bot by connecting the esp32 to the controller via mosquitto server through wifi medium. \
